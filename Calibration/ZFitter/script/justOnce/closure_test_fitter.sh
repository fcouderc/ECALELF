...
do
	...
	./script/haddTGraph.sh -o ${workDir}outProfile_ptRatio_pt2Sum_random_${scale}_${const}_${regionsFile}_Et_25_trigger_noPF.root ${workDir}*/outProfile_ptRatio_pt2Sum_random_${regionsFile}_Et_25_trigger_noPF.root
